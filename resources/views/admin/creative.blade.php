            ...
            <div class="col-12 col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">kreativ topshiriqlar</h5>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($res as $id => $item)
                            <tr>
                                <td>{{ $id+1 }}</td>
                                <td>{{ $item->body }}</td>
                                <td><img src="{{ asset('img/qr/'.$item->photo) }}" alt="" class="img-fluid w-25"></td>
                                <td>
                                    <form action="{{ route('admin.creativ.delete') }}" method="post">
                                        @csrf
                ...
                <div class="">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Yangi kreativ topshiriq qo'shish</h5>
                        </div>
                        <div class="card-body h-100">
                            <form action="{{ route('admin.creative.upload') }}" method="post"
