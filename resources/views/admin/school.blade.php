            ...
            <div class="col-12 col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">Maktab darsliklar</h5>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($books as $id => $item)
                            <tr>
                                <td>{{ $id+1 }}</td>
                                <td>{{ $item->name }}</td>
                                <td><a href="{{ route('admin.school.download', ['id' => $item->id]) }}">{{ $item->file }}</a></td>
                                <td>
                                    <form action="{{ route('admin.school.delete') }}" method="post">
                                        @csrf
                ...
                <div class="">
                    <div class="card">
                        ...
                        <div class="card-body h-100">
                            <form action="{{ route('admin.school.upload') }}" method="post"
